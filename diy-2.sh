...
sed -i "/uci commit network/i\uci set network.lan.ipaddr='10.8.8.8'" package/lean/default-settings/files/zzz-default-settings                   # IPv4 地址(openwrt后台地址)
...
sed -i "/uci commit network/i\uci set network.lan.gateway='10.8.8.1'" package/lean/default-settings/files/zzz-default-settings                  # IPv4 网关
sed -i "/uci commit network/i\uci set network.lan.broadcast='10.10.10.255'" package/lean/default-settings/files/zzz-default-settings            # IPv4 广播
...
sed -i "s/OpenWrt /mmm @ OpenWrt /g" package/lean/default-settings/files/zzz-default-settings
